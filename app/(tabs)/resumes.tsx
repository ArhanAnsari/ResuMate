  ...
  return (
    <SafeAreaView className="flex-1 bg-background">
      <View className="px-6 py-4 border-b border-border bg-surface flex-row justify-between items-center">
        ...
        <PremiumButton title="New" size="sm" onPress={handleCreateNew} />
      </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View className="items-center justify-center mt-20">
            <Text className="text-textSecondary text-base text-center mb-4">
            ...
            <View className="mt-4 flex-row gap-2">
              <View className="bg-background px-3 py-1 rounded-full">
                <Text className="text-textSecondary text-xs">
                  {(item.experience?.length || 0) > 0
                    ? `${item.experience.length} Exp`
                    : "No Exp"}
                </Text>
              </View>
              <View className="bg-background px-3 py-1 rounded-full">
