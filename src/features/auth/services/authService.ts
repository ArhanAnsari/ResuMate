...
import { LoginCredentials, RegisterCredentials, UserProfile } from '@/src/types/auth'; // Need to create types
...
function mapAppwriteUserToProfile(user: Models.User<Models.Preferences>): UserProfile {
  return {
    id: user.$id,
    name: user.name,
    email: user.email,
