      ...
      <View style={styles.overlay}>
        <View style={styles.container}>
          <View style={styles.header}>
            ...
            <MaterialIcons name="close" size={24} color={COLORS.textSecondary} onPress={onClose} />
          </View>
             ...
             {generatedContent ? (
                 <View style={styles.resultContainer}>
                     ...
                     <View style={styles.footer}>
                        <PremiumButton title="Use This" onPress={handleApply} style={{ flex: 1 }} />
                     </View>
                 </View>
             ) : (
                <View style={styles.placeholder}>
                     <Text style={styles.placeholderText}>
                        Enter a prompt above and let AI help you write the perfect resume content.
                     </Text>
                </View>
             )}
          </View>
